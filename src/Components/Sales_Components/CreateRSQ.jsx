              ...
              >
                ...
                <TableCell>
                  <Autocomplete
                    ...
                    getOptionLabel={(option) => {
                      if (!option) return '';
                      return option.productCode || option.code || '';
                    }}
                      ...
                      <li {...props} key={option.productID || option.id}>
                        <Box>
                          <Typography variant="body2" sx={{ fontWeight: 500 }}>
                            {option.productCode || option.code || ''}
                          </Typography>
                    ...
                    renderInput={(params) => (
                      <TextField
                        {...params}
                        placeholder="Chọn hoặc nhập mã/tên sản phẩm"
                        variant="standard"
                        InputProps={{
                          ...params.InputProps,
                          endAdornment: (
                ...
                <TableCell>
                  <TextField
                    ...
                    sx={{ 
                      '& .MuiInputBase-input': { 
                        color: row.productName ? 'inherit' : 'text.disabled' 
                      }
                    }}
                  />
                </TableCell>
