...
const Profile = () => {
	...
	const getRoleLabel = (userData) => {
		...
		// Fallback: kiểm tra trong userData
		if (userData?.role) {
							...
							<Col md={4}>
								<Card className="text-center p-4 shadow-sm h-100">
									...
									<Card.Img
										...
										onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = "/images/avatar/image1.png"; }}
										alt="User Avatar"
							...
							<Col md={8}>
								<Card className="p-4 shadow-sm h-100">
									<Card.Body>
										...
										<hr />
										<Row>
											<Col sm={4}><strong>Mã khách hàng:</strong></Col>
										...
										<Row className="mt-2">
											...
											<Col sm={8}>{getValue(profile.createAt || profile.CreateAt ? new Date(profile.createAt || profile.CreateAt).toLocaleDateString() : "")}</Col>
										</Row>
										<hr />
										<Row className="mt-2">
										...
										<Row className="mt-2">
											...
											<Col sm={8}>{getGenderLabel(profile.gender || profile.Gender)}</Col>
										</Row>
