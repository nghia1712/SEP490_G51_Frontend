...
// Import configs
import { customerFunctions, customerQuickActions } from "../RoleConfigs/customerConfig.jsx";
    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1, py: 4 }}>
        ...
        <Box sx={{ textAlign: "center", mb: 6 }}>
          ...
          >
            Mua sắm và quản lý đơn hàng thuốc
          </Typography>
        </Box>
        ...
        <SearchBar
          ...
          placeholder="Tìm kiếm thuốc hoặc chức năng..."
        />
