...
// Import configs
import { salesStaffFunctions, salesStaffQuickActions } from "../RoleConfigs/salesStaffConfig.jsx";
...
const SalesStaffDashboard = () => {
  ...
  const accessibleFunctions = useMemo(() => {
    ...
    if (currentRole !== 'sales_staff' && currentRole !== 'manager') {
      return [];
    }
    
    return salesStaffFunctions;
  }, [userRole]);
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1, py: 4 }}>
        ...
        <Box sx={{ mb: 6 }}>
          ...
          <Grid container spacing={3} justifyContent="center">
            {salesStaffQuickActions.map((action) => (
        ...
        <SearchBar
          ...
          placeholder="Tìm kiếm chức năng bán hàng..."
        />
