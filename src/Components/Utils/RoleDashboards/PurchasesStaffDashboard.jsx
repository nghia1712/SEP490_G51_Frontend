...
// Import configs
import { purchasesStaffFunctions, purchasesStaffQuickActions } from "../RoleConfigs/purchasesStaffConfig.jsx";
...
const PurchasesStaffDashboard = () => {
  ...
  const accessibleFunctions = useMemo(() => {
    ...
    if (currentRole !== 'purchases_staff' && currentRole !== 'manager') {
      return [];
    }
    
    return purchasesStaffFunctions;
  }, [userRole]);
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1, py: 4 }}>
        ...
        <Box sx={{ mb: 6 }}>
          ...
          <Grid container spacing={3} justifyContent="center">
            {purchasesStaffQuickActions.map((action) => (
        ...
        <SearchBar
          ...
          placeholder="Tìm kiếm chức năng mua hàng..."
        />
...
export default PurchasesStaffDashboard;
