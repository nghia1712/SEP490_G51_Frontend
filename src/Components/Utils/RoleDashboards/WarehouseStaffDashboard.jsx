...
// Import configs
import { warehouseStaffFunctions, warehouseStaffQuickActions } from "../RoleConfigs/warehouseStaffConfig.jsx";
...
const WarehouseStaffDashboard = () => {
  ...
  const accessibleFunctions = useMemo(() => {
    ...
    if (currentRole !== 'warehouse_staff' && currentRole !== 'manager') {
      return [];
    }
    
    return warehouseStaffFunctions;
  }, [userRole]);
    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1, py: 4 }}>
        ...
        <Box sx={{ textAlign: "center", mb: 6 }}>
          ...
          >
            Quản lý kho và kiểm kê tồn kho
          </Typography>
        </Box>
        ...
        <Box sx={{ mb: 6 }}>
          ...
          <Grid container spacing={3} justifyContent="center">
            {warehouseStaffQuickActions.map((action) => (
        ...
        <SearchBar
          ...
          placeholder="Tìm kiếm chức năng kho..."
        />
