...
const salesOrderAPI = {
  ...
  // POST /api/SalesOrder/confirm-payment?orderId={orderId}
  confirmPayment: (orderId, status) => authorApi.post(`${API_URL}/confirm-payment?orderId=${orderId}`, { status }),
  ...
  updateDraftQuantities: (items) => authorApi.put(`${API_URL}/draft/${items.salesOrderId}/quantities`, items),
  ...
  listNotDelivered: () => authorApi.get(`${API_URL}/list-sales-order-not-delivered`),
